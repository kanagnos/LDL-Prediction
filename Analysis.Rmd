...
LDLfIndep1RegrSEE <- fSEE(dfIndep1$LDLf, dfIndep1$LDLd)
...
LDLfIndep2RegrSEE <- fSEE(dfIndep2$LDLf, dfIndep2$LDLd)
...
LDLnIndep1RegrSEE <- fSEE(dfIndep1$LDLn, dfIndep1$LDLd)
LDLnIndep1RegrSEE <- formatC(LDLnIndep1RegrSEE, digits=2, format="f")
LDLnIndep2RegrSEE <- fSEE(dfIndep2$LDLn, dfIndep2$LDLd)
